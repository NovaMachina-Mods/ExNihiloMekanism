  ...
  public static void gatherData(GatherDataEvent event) {
    ...
    if (event.includeServer()) {
      ...
      generator.addProvider(
          true, new ExNihiloMekanismRecipeGenerator(packoutput, event.getExistingFileHelper()));
      // Tags
      generator.addProvider(
          true,
    ...
    if (event.includeClient()) {
      // Models
      generator.addProvider(
          true, new ExNihiloMekanismOreItemGenerator(packoutput, event.getExistingFileHelper()));
      // Lang
